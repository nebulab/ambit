...
describe("hook entity", () => {
  ...
  /**
   * Shape alone — whether the file is there is the catalog's question, and an inline hook has no
   * directory to ask. What these three have in common is that no directory contents could make them
   * legal, which is why the parser can refuse them without looking.
   *
